    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="d-flex" action="search.php" method="get">
                <input onkeyup="getLikeProductSearch( this.value )" class="form-control me-2" type="search" autocomplete="off" id="searchInput" placeholder="Search" aria-label="Search" name="q">
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="mt-3">
                <h5 class="text-right">Chuyên mục</h5>
                <ul class="mt-2 text-right" style="list-style-type: none;">
                    <?php foreach ( $categoryList as $item ) { ?>
                        <label class="form-check-label">
                            <input name="checkbox-categories" type="checkbox" class="checkbox-categories" value="<?php echo $item['id']; ?>" id="category-<?php echo $item['id']; ?>">
